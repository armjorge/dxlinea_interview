...
CREATE OR REPLACE TABLE readme AS
SELECT
    $1:"Delinea | Senior Data Analyst case study"::VARCHAR AS "Delinea | Senior Data Analyst case study",
    $1:"Unnamed: 1"::VARCHAR AS "Unnamed: 1",
    $1:"Unnamed: 2"::VARCHAR AS "Unnamed: 2",
    $1:"Unnamed: 3"::VARCHAR AS "Unnamed: 3"
FROM @DXLINEA_INTERVIEW.RAW_DXLINEA.RAW_DXLINEA_STAGE/README.parquet
